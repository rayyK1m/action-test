...
import { OutIcon } from '@goorm-dev/gds-icons';
...
const COLUMNS = [
    ...
    },
    {
        ...
        header: <></>,
        cell: () => (
            <Button color="link" icon={<OutIcon />} disabled>
                퇴장
            </Button>
        ),
...
function CampParticipantTableLoading() {
...
export default CampParticipantTableLoading;
